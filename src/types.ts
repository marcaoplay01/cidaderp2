...
export const VEHICLES: Vehicle[] = [
  ...
  {
    id: 'vip_s1000rr',
    name: 'BMW S1000RR M-Sport (VIP Bronze)',
    price: 0,
    description: 'Moto superesportiva alemã. Aceleração absurda e bônus de rendimento de elite exclusiva para membros VIP.',
    speed: 299,
    consumption: 3,
    multiplier: 3.2,
    type: 'moto',
...
export const JOBS: Job[] = [
  {
    ...
    description: 'Suba na bicicleta ou na moto e faça entregas de hambúrguer e lanches na favela.',
    baseReward: 50,
    xpReward: 15,
    energyCost: 10,
  ...
  },
  {
    ...
    xpReward: 35,
    energyCost: 15,
    requiredVehicleId: 'gol_quadrado', // Requires Gol or better
